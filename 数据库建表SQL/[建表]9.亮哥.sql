...
CREATE TABLE [dbo].[plan_EnergyConsumptionYearlyPlan](
	...
	[January] [varchar](64) DEFAULT(0) NULL,
	[February] [varchar](64) DEFAULT(0) NULL,
	[March] [varchar](64) DEFAULT(0) NULL,
	[April] [varchar](64) DEFAULT(0) NULL,
	[May] [varchar](64) DEFAULT(0) NULL,
	[June] [varchar](64) DEFAULT(0) NULL,
	[July] [varchar](64) DEFAULT(0) NULL,
	[August] [varchar](64) DEFAULT(0) NULL,
	[September] [varchar](64) DEFAULT(0) NULL,
	[October] [varchar](64) DEFAULT(0) NULL,
	[November] [varchar](64) DEFAULT(0) NULL,
	[December] [varchar](64) DEFAULT(0) NULL,
	[Totals] [varchar](256) DEFAULT(0) NULL,
