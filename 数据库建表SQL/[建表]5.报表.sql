...
CREATE TABLE [dbo].[report_ClinkerMonthlyCoalDustConsumption](					--孰料生产用煤月统计分析
	...
	--甲班
	[First_Clinker_Output] [bigint] NULL,                     					--熟料产量
    [First_KilnHead_CoalDust] [bigint] NULL,                  					--窑头用煤量
	[First_KilnTail_CoalDust] [bigint] NULL,                  					--窑尾用煤量
	[First_sum_CoalDust] [bigint] NULL,                       					--合计用煤量
	[First_CoalDustConsumption] [decimal](8, 2) NULL,                			--煤耗
	--乙班
	[Second_Clinker_Output] [bigint] NULL,                     					--熟料产量
    [Second_KilnHead_CoalDust] [bigint] NULL,                  					--窑头用煤量
	[Second_KilnTail_CoalDust] [bigint] NULL,                  					--窑尾用煤量
	[Second_sum_CoalDust] [bigint] NULL,                       					--合计用煤量
	[Second_CoalDustConsumption] [decimal](8, 2) NULL,                			--煤耗
	--丙班
	[Third_Clinker_Output] [bigint] NULL,                     					--熟料产量
    [Third_KilnHead_CoalDust] [bigint] NULL,                  					--窑头用煤量
	[Third_KilnTail_CoalDust] [bigint] NULL,                  					--窑尾用煤量
	[Third_sum_CoalDust] [bigint] NULL,                       					--合计用煤量
	[Third_CoalDustConsumption] [decimal](8, 2) NULL,                			--煤耗
	--合计
	[Amountto_Clinker_Output] [bigint] NULL,                     				--熟料产量
    [Amountto_KilnHead_CoalDust] [bigint] NULL,                  				--窑头用煤量
	[Amountto_KilnTail_CoalDust] [bigint] NULL,                  				--窑尾用煤量
	[Amountto_sum_CoalDust] [bigint] NULL,                       				--合计用煤量
...
CREATE TABLE [dbo].[report_TeamClinkerMonthlyProcessEnergyConsumption](			--班组熟料生产工序能耗月统计报表
	...
	[Amountto_ElectricityConsumption_RawBatchGrinding] [decimal](18, 4) NULL, 	-- 电耗-生料磨 
