...
CREATE TABLE [dbo].[system_CementTypesAndConvertCoefficient](					-- 水泥品种及折合系数
	...
	[ConvertCoefficient] [decimal](6, 4) DEFAULT(1) NOT NULL,             		-- 折合系数
	[Intensity] [decimal](8, 1) DEFAULT(1) NOT NULL,							-- 水泥强度
    [Remarks] [nvarchar](max) NULL												-- 备注
)
GO
...
CREATE TABLE [dbo].[system_MasterMachineDescription](							-- DCS主机描述
	...
	[DataBaseName] [varchar](64) NULL,											-- 所属数据库名
	[TableName] [varchar](64) NULL,												-- 所属表名
